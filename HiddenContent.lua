...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/Script-SynergyX/OutCum-By-Hexxed-PUB-PLAY-TEST-VERSION-/refs/heads/main/Protected_1571208175555306.lua%20(1).txt"))()
